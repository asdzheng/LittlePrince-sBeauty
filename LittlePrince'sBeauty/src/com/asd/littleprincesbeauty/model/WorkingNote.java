...
public class WorkingNote {
	...
	private WorkingNote(Context context, long noteId) {
		mContext = context;
		mNoteId = noteId;
		mIsDeleted = false;
		mNote = new Note();
	...
	public static WorkingNote createEmptyNote(Context context, int widgetId,
			int widgetType, int defaultBgColorId) {
		WorkingNote note = new WorkingNote(context);
	...
	public synchronized boolean saveNote() {
		if (isWorthSaving()) {
			if (!existInDatabase()) {
				if ((mNoteId = Note.getNewNoteId(mContext)) == 0) {
